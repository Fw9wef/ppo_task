"""
PPO Agent for MuJoCo Half Cheetah environment using Gymnasium.
"""
...
class Agent:
    ...
    def learn(self, next_state: np.ndarray, test_run=False) -> None:
...
class SimpleAgent:
    ...
    def select_action(
        ...
        with torch.no_grad():
            action, _, _ = self.policy.act(state_tensor, deterministic)
